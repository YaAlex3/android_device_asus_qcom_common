...
def FullOTA_InstallEnd(info):
  info.script.AppendExtra('package_extract_file("install/Z010DD", "/tmp/install/Z010DD");');
  info.script.AppendExtra('package_extract_file("install/bin/install.asus.sh", "/tmp/install/bin/install.asus.sh");');
  info.script.Mount("/system")
  info.script.AppendExtra('run_program("sbin/sh", "/tmp/install/bin/install.asus.sh");');
